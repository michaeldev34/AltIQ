...
# CompressedManifestStaticFilesStorage is strict and requires all files to exist
# CompressedStaticFilesStorage is more forgiving and won't fail on missing files
if not DEBUG:
